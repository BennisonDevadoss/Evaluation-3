...
let person = new Person("Bennison", "Tirunelveli");
console.log(person);
Person.staticMethod("Bennison Devadoss", "Tirunelveli");  // And the static method can be only accessed by the class name. 